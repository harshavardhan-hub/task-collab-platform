    ...
    <div className="relative">
      ...
      {showDropdown && (
        <>
          ...
          />
          <div className="absolute right-0 top-full mt-2 w-96 bg-white dark:bg-dark-card rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 z-40 max-h-[500px] flex flex-col">
            {/* Header */}
