  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FAFAFA] dark:bg-[#0A0A0B] relative overflow-hidden p-4">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[20%] right-[10%] w-[20%] h-[20%] bg-accent-500/5 dark:bg-accent-500/5 blur-[80px] rounded-full" />
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl lg:text-4xl font-display font-bold text-secondary-900 dark:text-white mb-2 tracking-tight">Welcome Back</h1>
          <p className="text-secondary-500 dark:text-secondary-400 font-medium tracking-wide">Enter your details to sign in.</p>
        </div>
